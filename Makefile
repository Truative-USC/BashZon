...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Apr 28 23:15:46 2017
# Project:  hw8.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hw81.0.0/ && $(COPY_FILE) --parents book.h clothing.h datastore.h db_parser.h heap.h main_window.h mergsort.h movie.h msort.h multiwin.h mydatastore.h newheap.h product.h product_parser.h review.h splaytree.h user.h util.h .tmp/hw81.0.0/ && $(COPY_FILE) --parents amazon.cpp book.cpp clothing.cpp db_parser.cpp main_window.cpp movie.cpp mutliwin.cpp mydatastore.cpp product.cpp product_parser.cpp review.cpp user.cpp util.cpp .tmp/hw81.0.0/ && (cd `dirname .tmp/hw81.0.0` && $(TAR) hw81.0.0.tar hw81.0.0 && $(COMPRESS) hw81.0.0.tar) && $(MOVE) `dirname .tmp/hw81.0.0`/hw81.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hw81.0.0
...
compiler_moc_header_make_all: moc_main_window.cpp moc_multiwin.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_main_window.cpp moc_multiwin.cpp
...
mutliwin.o: mutliwin.cpp multiwin.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mutliwin.o mutliwin.cpp
...
review.o: review.cpp review.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o review.o review.cpp
