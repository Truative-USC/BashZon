...
Product *ProductBookParser::makeProduct() {
  Product *newBook = 
  new Book(categoryID(), prodName_, price_, qty_, author_, isbn_);
  return newBook;
}
...
Product *ProductClothingParser::makeProduct() {
  Product *newClothing = 
  new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
  return newClothing;
}
...
Product *ProductMovieParser::makeProduct() {
  Product *newMovie = 
  new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
  return newMovie;
}
